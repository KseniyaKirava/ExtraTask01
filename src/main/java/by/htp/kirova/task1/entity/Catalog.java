 ...
 *       &lt;sequence&gt;
 *         &lt;element name="category" type="{http://catalogLib.kirova.htp.by}Category" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Catalog {
    ...
    // каталог вряд ли потребуется когда-либо сравнивать в данном таске, но, для последующих реализаций и по правилам Java Bean
    @Override
